...
class PascalVOC2coco(object):
    def __init__(self, xml=[], save_json_path='./new.json'):
        ...
        self.images = []
        self.categories = [{"supercategory": "none", "id": 1, "name": "pedestrian"},
    ...
    def data_transfer(self):
        for num, json_file in enumerate(self.xml):
            ...
            # obj_path = glob.glob(os.path.join(path, 'SegmentationObject', '*.jpg'))
            # print(obj_path)
...
xml_file = glob.glob('/home/fengzicai/Documents/predict/val_400_200_100/xml/*.xml')
# xml_file=['./Annotations/000032.xml']
# xml_file=['00000007_05499_d_0000037.xml']
PascalVOC2coco(xml_file, '/home/fengzicai/Documents/predict/val_400_200_100/val.json')
